...
/// @summary Parses a path string to extract the metadata associated with a
/// resource that is encoded as part of the filename extension information.
...
/// @summary Constructor function for the SourceDatabase type, which maintains
/// data about source files referenced by the content.
...
/// @summary Loads data from a file into the database. Any existing data is
/// overwritten by data loaded from the file.
...
/// @summary Saves the current database contents to a file and resets the dirty
...
/// @summary Creates a new database entry representing a given source file. The
...
/// @summary Queries the SourceDatabase to retrieve the entry representing the
...
/// @summary Inserts an entry into the database. If the entry exists, the
/// existing entry is overwritten. Otherwise, the entry is added.
...
/// @summary Deletes the database entry representing a given source file.
/// @param rootPath The absolute path of the package root directory.
/// @param sourcePath The absolute path of the source file.
...
/// @summary Retrieves a the absolute path for a specific file that references
/// a given source file.
...
/// @summary Retrieves the absolute path for specific file referenced by a
/// given source source file.
/// @param entry The source database entry.
/// @param rootPath The absolute path of the package root directory.
/// @param index The zero-based index of the reference to retrieve.
...
/// @summary Adds a reference link from one source file to another.
...
/// @summary Adds a dependency link from one source file to another.
...
/// @summary Constructor function for the TargetDatabase type, which maintains
/// data about target files output by the content pipeline.
...
/// @summary Creates a new database entry representing a given target file. The
/// entry is not inserted into the database.
/// @param rootPath The absolute path of the package root directory.
/// @param sourcePath The absolute path of the source file.
...
/// @summary Queries the TargetDatabase to retrieve the entry representing the
...
/// @summary Deletes the database entry representing a given target file.
/// @param rootPath The absolute path of the package root directory.
/// @param sourcePath The absolute path of the target file.
...
/// @summary Retrieves the absolute path for specific output file.
...
/// @summary Adds an output file reference.
...
/// @summary Attempts to load a source database from a file.
...
/// @summary Creates a new, empty source database.
...
/// @summary Attempts to load a target database from a file.
/// @param path The path of the file to load.
...
/// @summary Creates a new, empty target database.
