...
/// @summary The global server instance. All operations that occur on the
/// worker thread are forwarded to this server instance.
var server       = new ContentJS.ContentServer();

/// @summary Callback to handle messages received from the parent script.
...
/// @summary Callback to handle messages generated by the content server. These
/// messages are sent back to the parent script.
...
/// @summary Callback to handle errors generated by the content server. The
/// error is sent back to the parent script.
/// @param sender The ContentJS.ContentServer instance that raised the event.
